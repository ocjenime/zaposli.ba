...
import {
  MapPin, Clock, BadgeCheck, ArrowRight, Loader2, Send,
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-3 text-xs text-steel mb-4">
                        ...
                        <span className="flex items-center gap-1.5 font-medium text-gray-700">
                          <span className="inline-flex items-center justify-center w-5 h-5 rounded bg-brand-orange/10 text-[10px] font-bold text-brand-orange leading-none">KM</span>
                          {formatBudget(job)}
                        </span>
                        {job.deadline && (
