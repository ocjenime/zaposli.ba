...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Zaposli.ba — Pronađite majstore za vaš projekat',
    template: '%s',
  },
  ...
  openGraph: {
    ...
    locale: 'bs_BA',
    type: 'website',
    images: [{ url: 'images/og-cover.png', width: 1200, height: 630, alt: 'Zaposli.ba — Pronađite majstora za vaš projekat' }],
  },
  twitter: {
