...
export default function FirmEditModal({ firm, onClose, onSaved }: FirmEditModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4">
      <div className="bg-white dark:bg-gray-900 sm:rounded-2xl rounded-t-2xl sm:shadow-xl shadow-2xl w-full max-w-2xl sm:max-h-[90vh] h-[92vh] sm:h-auto overflow-y-auto border-t sm:border border-gray-100 dark:border-gray-800">
        <div className="p-6">
