...
export default function FirmRecentBids({ bids }: FirmRecentBidsProps) {
  ...
  return (
    <div className="bg-white dark:bg-ink-900 rounded-2xl border border-gray-100 dark:border-ink-800 p-4 shadow-sm">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-bold text-gray-900 dark:text-white">Moje ponude</h3>
        <Link
      ...
      {recent.length === 0 ? (
        <div className="text-center py-6">
          ...
          <p className="text-sm text-steel">Još nema ponuda.</p>
          <Link
