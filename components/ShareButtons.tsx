    ...
    <div className="flex items-center justify-center gap-1.5 sm:gap-2 flex-wrap max-w-full">
      ...
      {links.map(({ label, href, bg, Icon }) => (
        <a
          ...
          className={`inline-flex items-center gap-1 text-white text-[11px] sm:text-xs font-bold px-2.5 sm:px-3 py-2 rounded-xl transition-all active:scale-95 ${bg}`}
        >
      ...
      <a
        ...
        className="inline-flex items-center gap-1 text-white text-[11px] sm:text-xs font-bold px-2.5 sm:px-3 py-2 rounded-xl bg-[#1877f2] hover:bg-[#1466d6] transition-all active:scale-95"
      >
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 sm:w-4 sm:h-4" aria-hidden="true">
      ...
      <button
        ...
        title="Kopiraj link"
        className={`inline-flex items-center gap-1 text-[11px] sm:text-xs font-bold px-2.5 sm:px-3 py-2 rounded-xl border transition-all active:scale-95 ${
          copied
