    ...
    <section className="relative -mt-3 md:-mt-8 z-30 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="bg-white dark:bg-ink-900 rounded-2xl border border-gray-100 dark:border-ink-800 shadow-xl shadow-black/5 p-3 sm:p-5">
          <div className="flex items-start justify-start gap-3 overflow-x-auto no-scrollbar pb-1">
            {featured.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[11px] sm:text-xs font-medium text-gray-700 dark:text-[#ffffff]/85 group-hover:text-brand-orange transition-colors leading-tight px-1 h-8 line-clamp-2 flex items-center justify-center">
                    {category!.name}
                  </span>
                </Link>
              );
