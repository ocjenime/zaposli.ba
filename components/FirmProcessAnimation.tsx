...
function Majstor(props: {
  ...
  return (
    <g className="anim-float-subtle">
      {/* Noge / cipele */}
      <g transform={t(0, 0)}>
        <rect x="-16" y="54" width="14" height="14" rx="4" fill="#1E293B" />
        <rect x="2" y="54" width="14" height="14" rx="4" fill="#1E293B" />
      </g>

      {/* Hlače */}
      <g transform={t(0, 0)}>
        <rect x="-20" y="30" width="40" height="30" rx="6" fill={PANTS} />
      </g>

      {/* Telo — radna košulja / majica */}
      <g transform={t(0, 0)}>
      ...
      <g transform={t(0, 0)}>
        <path
          d="M-15 -10 C-15 -22 -8 -26 0 -26 C8 -26 15 -22 15 -10 C15 -5 12 -3 10 -3 C10 -8 8 -12 0 -12 C-8 -12 -10 -8 -10 -3 C-12 -3 -15 -5 -15 -10 Z"
          fill={HAIR}
        />
        <path d="M-12 -8 C-8 -10 -4 -10 0 -10 C4 -10 8 -10 12 -8" stroke={HAIR} strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.7" />
      </g>

      {/* Brada / brkovi */}
      <g transform={t(0, 0)}>
        <path d="M-4 -2 Q0 1 4 -2" stroke={HAIR} strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.6" />
      </g>
      ...
      <g transform={t(0, 0)}>
        ...
        <circle cx="5" cy="-9" r="2" fill={INK} />
        {/* Obrve */}
        <path d="M-8 -13 L-2 -13" stroke={HAIR} strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.6" />
        <path d="M2 -13 L8 -13" stroke={HAIR} strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.6" />
      </g>
      ...
      {toolBelt && (
        <g transform={t(0, 0)}>
          <rect x="-22" y="38" width="44" height="8" rx="2" fill={BELT} />
          {/* Džep na pojasu */}
          <rect x="12" y="36" width="10" height="14" rx="2" fill={BELT} />
          {/* Ključ viri */}
          <g transform="rotate(-25 16 38)">
            <rect x="14" y="28" width="4" height="16" rx="1" fill={STEEL} />
            <circle cx="16" cy="26" r="5" fill={STEEL} />
      ...
      {/* Lijeva ruka */}
      <g transform={t(0, 0)}>
        <rect x="-32" y="18" width="10" height="20" rx="5" fill={SKIN} />
      </g>

      {/* Desna ruka s objektom */}
      {arm === 'clipboard' && (
        <g transform={t(0, 0)}>
          <rect x="22" y="10" width="8" height="18" rx="4" fill={SKIN} />
        </g>
      )}
      {arm === 'phone' && (
        <g transform={t(0, 0)}>
          <rect x="20" y="6" width="8" height="22" rx="4" fill={SKIN} transform="rotate(-10 24 17)" />
        </g>
      )}
      {arm === 'document' && (
        <g transform={t(0, 0)}>
          <rect x="22" y="8" width="8" height="20" rx="4" fill={SKIN} />
        </g>
      )}
      {arm === 'wallet' && (
        <g transform={t(0, 0)}>
          <rect x="20" y="12" width="8" height="18" rx="4" fill={SKIN} transform="rotate(-15 24 21)" />
        </g>
      )}
    </g>
  );
...
export function FirmProcessAnimation() {
  return (
    <div className="w-full max-w-6xl mx-auto">
      ...
      >
        <title id="firm-title">
          Kako funkcioniše za firme i majstore: 1. Registruj se, 2. Pronađi
          posao, 3. Pošalji ponudu, 4. Zaradi
        </title>
        ...
        <g>
          ...
          <g>
            ...
            <text x="106" y="93" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="12" fontWeight="800" fill={WHITE}>1</text>
          </g>
        </g>

        <text x="150" y="232" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="12" fontWeight="700" fill={INK} letterSpacing="0.05em">REGISTRUJ SE</text>
        <text x="150" y="250" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="10" fill={STEEL}>Profil firme/majstora</text>
        ...
        <g>
          ...
          <g className="anim-float-subtle">
            ...
            <text x="440" y="160" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="7" fontWeight="700" fill={WHITE}>NOVO</text>
          </g>

          {/* Radni kombi / vozilo u pozadini */}
          <g className="anim-drive-subtle">
            <rect x="286" y="152" width="54" height="26" rx="6" fill={INK} />
            <rect x="326" y="152" width="12" height="20" rx="2" fill={WHITE} opacity="0.9" />
          ...
          <g>
            ...
            <text x="346" y="93" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="12" fontWeight="800" fill={WHITE}>2</text>
          </g>
        </g>

        <text x="390" y="232" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="12" fontWeight="700" fill={INK} letterSpacing="0.05em">PRONAĐI POSAO</text>
        <text x="390" y="250" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="10" fill={STEEL}>Dobijaj notifikacije</text>
        ...
        <g>
          ...
          <g className="anim-float-subtle">
            ...
            <text x="666" y="165" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="8" fontWeight="800" fill={WHITE}>500 KM</text>
            {/* Pečat */}
          ...
          <g>
            ...
            <text x="586" y="93" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="12" fontWeight="800" fill={WHITE}>3</text>
          </g>
        </g>

        <text x="630" y="232" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="12" fontWeight="700" fill={INK} letterSpacing="0.05em">POŠALJI PONUDU</text>
        <text x="630" y="250" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="10" fill={STEEL}>Brzo i jednostavno</text>
        ...
        <g>
          ...
          <g transform="translate(866, 140) rotate(-15)">
            <rect x="0" y="0" width="44" height="28" rx="6" fill={INK} />
            ...
            <text x="20" y="16" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="5" fontWeight="700" fill={WHITE}>KM</text>
          </g>
          ...
          <g className="anim-cash-float">
            ...
            <text x="934" y="112" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="8" fontWeight="700" fill={WHITE}>KM</text>
          </g>
          <g className="anim-cash-float anim-cash-float-delay">
            ...
            <text x="920" y="137" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="6" fontWeight="700" fill={INK}>KM</text>
          </g>
          <g className="anim-cash-float anim-cash-float-delay-2">
            ...
            <text x="939" y="153" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="6" fontWeight="700" fill={WHITE}>KM</text>
          </g>

          {/* Kovanice */}
          <g className="anim-cash-float anim-cash-float-delay">
            <circle cx="900" cy="102" r="8" fill={YELLOW} stroke={INK} strokeWidth="1.5" />
            <text x="900" y="106" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="7" fontWeight="700" fill={INK}>2</text>
          </g>
          <g className="anim-cash-float anim-cash-float-delay-2">
            <circle cx="940" cy="82" r="8" fill={YELLOW} stroke={INK} strokeWidth="1.5" />
            <text x="940" y="86" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="7" fontWeight="700" fill={INK}>5</text>
          </g>
          ...
          <g>
            ...
            <text x="826" y="93" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="12" fontWeight="800" fill={WHITE}>4</text>
          </g>
        </g>

        <text x="870" y="232" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="12" fontWeight="700" fill={INK} letterSpacing="0.05em">ZARADI</text>
        <text x="870" y="250" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="10" fill={STEEL}>Keš + ocjene</text>
      </svg>
    </div>
  );
}
