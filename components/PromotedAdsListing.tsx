...
export default async function PromotedAdsListing({ breadcrumbLabel }: { breadcrumbLabel: string }) {
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {fetchError ? (
              ...
              <div className="text-center py-16 md:py-24">
                ...
                <h2 className="text-xl font-bold text-white mb-2">Trenutno nema oglasa</h2>
