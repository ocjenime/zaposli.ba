...
- Created `components/AppStickerPopup.tsx`: on mobile, the sticker slides up as a large popup after the user scrolls ~400px down the homepage, with an X close button and localStorage dismissal so it stays closed.
