...
- Removed the large "Hitne intervencije" featured card from `/kategorije/` and replaced it with the same compact sticky red CTA bar at the bottom of the page, freeing up vertical space while keeping the emergency entry point always visible.
