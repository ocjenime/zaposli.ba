...
- Lightened the homepage hero overlays (`from-ink-950/85 via-ink-950/60 to-ink-950/30` → `/75 /50 /20`, bottom `/70 /20 /30` → `/60 /15 /20`) so the background photo shows more color while text stays readable.
