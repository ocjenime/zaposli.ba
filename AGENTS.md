...
- Refined the two role CTA cards (`components/RoleCTACards.tsx`) on mobile: full descriptions visible, larger cards, no bottom section padding on mobile so the cards sit flush against the sticky bottom CTA.
