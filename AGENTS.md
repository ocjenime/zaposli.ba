...
- Shifted the homepage hero background image to the right (`object-center` → `object-[75%_center]`) to hide a floating worker artifact in the bottom-right corner of the AI-generated image. `npm run lint` and `npm run build` both pass (2405 pages).
