...
export const cities: City[] = [
  ...
  { name: 'Bosanski Petrovac', slug: 'bosanski-petrovac', loc: 'Bosanskom Petrovacu' },
  { name: 'Bosanska Krupa', slug: 'bosanska-krupa', loc: 'Bosanskoj Krupi' },
  { name: 'Bosanski Novi', slug: 'bosanski-novi', loc: 'Bosanskom Novom' },
